		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[â—] Este comando sÃ³ pode ser usado pelo proprietÃ¡rio do grupo membro comum! âŒ',
					ownerB: '[â—] Este comando sÃ³ pode ser usado pelo  ! âŒ',
					admin: '[â—] Este comando sÃ³ pode ser usado por administradores do grupo membro comum! âŒ',
                ...
                break
                   ...
                   break
					...
					if (Number(args[0]) === 1) {
						...
						reply('✔️ SUCESSO tem mais boas vindas não k7')
